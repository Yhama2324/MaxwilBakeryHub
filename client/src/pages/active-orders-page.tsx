...
export default function ActiveOrdersPage() {
  ...
  // Filter active orders (pending, accepted, preparing, ready)
            ...
            <CardContent className="p-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-purple-600">{preparingOrders}</p>
                </div>
            ...
            <CardContent className="p-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-bold text-green-600">{activeOrders.filter(o => o.status === "ready").length}</p>
                </div>
